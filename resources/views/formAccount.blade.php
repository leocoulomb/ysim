...
@section('content')
    ...
    <div class="col-md-12 well well-md">
        <center><h1>Créer un compte</h1></center><hr><br/>
        <div class="form-horizontal">
            ...
            <div class="form-group">
                ...
                <div class="col-md-6  col-md-3">
                    <input type="text" name="adresse" class="form-control" placeholder="Votre adresse" required autofocus>
                </div>
            </div>
            <div class="form-group">
                <label class="col-md-3 control-label"><i class="fas fa-address-card"></i>&nbsp;&nbsp;&nbsp;Ville : </label>
                <div class="col-md-6  col-md-3">
                    <input type="text" name="ville" class="form-control" placeholder="Votre ville" required autofocus>
                </div>
            </div>
            <div class="form-group">
                <label class="col-md-3 control-label"><i class="fas fa-address-card"></i>&nbsp;&nbsp;&nbsp;Code postal : </label>
                <div class="col-md-6  col-md-3">
                    <input type="number" name="cp" class="form-control"  max="99999" placeholder="Votre code postal" required autofocus>
                </div>
            </div>
            <div class="form-group">
                <label class="col-md-3 control-label"><i class="fas fa-phone"></i>&nbsp;&nbsp;&nbsp;Téléphone : </label>
                <div class="col-md-6  col-md-3">
                    <input type="text" name="tel" class="form-control"  maxlength="10" placeholder="Votre numéro de téléphone" required autofocus>
                </div>
            </div>
            <div class="form-group">
                <div class="col-md-6 col-md-offset-3">
                    <br/>
                    <center>
                        <button type="submit" class="btn btn-default btn-primary"><i class="fas fa-sign-in-alt"></i> S'incrire</button>
